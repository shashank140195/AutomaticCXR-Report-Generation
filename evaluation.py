...
model = blip_decoder('/mnt/gpfs2_4m/scratch/sgu260/CS585/BLIP/output/pretrain4/checkpoint_99.pth',image_size=224,vit='base')
model.to(device)
model.eval()
pred_findings = []
gold_findings = []
data_dir = '/project/rvkavu2_uksr/sgu260/CS585/final_project/IUdata_updated.json'
import json
...
for it in tqdm(data):
    ...
    caption = model.generate(im, sample=False, num_beams=1, max_length=256, min_length=5)
